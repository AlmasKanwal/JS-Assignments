        ...
        <div class="carousel-caption d-flex flex-column justify-content-center align-items-center">
          <div class="winter-card" style="background-image: url('assets/wint56.jpg');">
            ...
            <div class="weather-info">
              <div class="weather-item">Sunday<br>-8°C<br><span class="time">6:45 AM</span></div>
              <div class="weather-item">Tuesday<br>-8°C<br><span class="time">6:36 AM</span></div>
              <div class="weather-item">Thursday<br>-2°C<br><span class="time">6:45 AM</span></div>
              <div class="weather-item">Wednesday<br>-5°C<br><span class="time">6:45 AM</span></div>
              <div class="weather-item">Friday<br>-2°C<br><span class="time">6:45 AM</span></div>
              <div class="weather-item">Saturday<br>0°C<br><span class="time">6:45 AM</span></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="carousel-item">
        ...
        <div class="carousel-caption d-flex flex-column justify-content-center align-items-center">
          <div class="winter-card" style="background-image: url('assets/winn.jpeg');">
            ...
            <div class="weather-info">
              <div class="weather-item">Sunday<br>-7°C<br><span class="time">7:00 AM</span></div>
              <div class="weather-item">Tuesday<br>-6°C<br><span class="time">7:10 AM</span></div>
              <div class="weather-item">Thursday<br>-1°C<br><span class="time">7:15 AM</span></div>
              <div class="weather-item">Wednesday<br>-4°C<br><span class="time">7:20 AM</span></div>
              <div class="weather-item">Friday<br>-3°C<br><span class="time">7:25 AM</span></div>
              <div class="weather-item">Saturday<br>1°C<br><span class="time">7:30 AM</span></div>
            </div>
          </div>
        </div>
      </div>
